classdef ATV_Dynamics_3 <handle
    properties
           %parameters
        ell
        r
    ...
    methods 
        function self = ATV_Dynamics_3(Param)
            self.v_A_hat = Param.v_A_hat;
            self.v_B_hat = Param.v_B_hat;
        ...
        %intialize states and positons
            ...
            self.states   = [Param.v_0 ; Param.chi_0 ; Param.phi_0]; %v is velocity of cart, chi is carts current heading, and phi is the wheel base angle or steering angle
        ...
        function [position_dot, states_dot] = dynamics(self, position, states, input)
            ...
            v_dot = self.v_A_hat*v + self.v_B_hat*e_in;
